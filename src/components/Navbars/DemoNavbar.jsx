...
class Header extends React.Component {
  ...
  getUid() {
    auth.onAuthStateChanged(user => {
      ...
      this._isMounted && this.getUser(this.state.currentUser.uid)
    })
  }

  getUser(uid) {
    db.collection('staffs').where('authId', '==', uid).get().then(snapshot => {
      snapshot.forEach(doc => {
        //console.log(doc.id, '=>', doc.data());
        this._isMounted && this.setState({ userDetail: doc.data() })
      })
      //console.log("userDetail |" + this.state.userDetail.role)
          ...
          {userDetail &&
            <>
              ...
              >
                ...
                &nbsp;&nbsp;
                <span className="regular-th">{userDetail.name}&nbsp;&nbsp;{userDetail.surname}&nbsp;</span>
                <Nav navbar>
                  <Dropdown
                    nav
                  ...
                  >
                    <DropdownToggle caret nav>
                      ...
                      />&nbsp;&nbsp;
                      <p>
                        <span className="d-lg-none d-md-block">&nbsp;{userDetail.name} {userDetail.surname}&nbsp;&nbsp;</span>
                      </p>
                    </DropdownToggle>
                    <DropdownMenu right >
                      <Card className="card-user">
                        ...
                        <CardBody style={{textAlign: 'center'}}>
                          <div className="regular-th cardBody">
                            ...
                            <hr />
                            <p className="title" style={{ fontSize: '30px' }}>{userDetail.name} {userDetail.surname}</p><br />
