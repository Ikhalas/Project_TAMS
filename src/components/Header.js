...
<div>
  <header className="main-header">
    ...
    <Link to="/" className="logo">
      ...
      <span className="logo-mini" style={font15}><b>T</b>AMS</span>
      {/* logo for regular state and mobile devices */}
      <span className="logo-lg title " style={font30}>อบต.ท่าข้าม</span>
    </Link>
        ...
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown user user-menu">
            <a href="fake_url" className="dropdown-toggle" data-toggle="dropdown">
              ...
              <span className="hidden-xs">Ikhalas Mannoon</span>
            </a>
          </li>
