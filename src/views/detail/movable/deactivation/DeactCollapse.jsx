...
export default class DeactCollapse extends Component {
  ...
  deactivateItem(data) {
    if (data) {
        db.collection('deactivatedItem').add(data).then(() => {
            db.collection('itemMovable').doc(this.props.itemId).update({ status: 'จำหน่าย' }).then(() => {
      ...
      <>
        ...
        >
          ...
          <ModalBody>
            ...
            >
              &nbsp;&nbsp;&nbsp;&nbsp;
              <i style={{ fontSize: "25px", color:'#ef8157' }} className="fas fa-exclamation-triangle"></i>
              &nbsp;&nbsp;
              <b>
                <span style={{ fontSize: "25px" }}>
